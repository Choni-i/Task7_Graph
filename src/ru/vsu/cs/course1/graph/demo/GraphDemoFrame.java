...
public class GraphDemoFrame extends JFrame {
    ...
    private JTextField blockedCityField;
    ...
    public GraphDemoFrame() {
        ...
        buttonCreateGraph.addActionListener(e -> {
            try {
                ...
                /*int startCity = Integer.parseInt(startCityField.getText());
                int endCity = Integer.parseInt(endCityField.getText());
                String [] BlockedCity = (blockedCityField.getText().split(","));
        ...
        buttonDfsRecursion.addActionListener(e -> {
            try {
                ...
                showSystemOut(() -> {
                    Set<Integer> blockedCity = new TreeSet<>();
                    //int[] res = new int[];
                    int startCity = Integer.parseInt(startCityField.getText());
                    int endCity = Integer.parseInt(endCityField.getText());
                    String[] BlockedCity = (blockedCityField.getText().split(" "));
                    for (int j = 0; j < BlockedCity.length; j++) {
                        blockedCity.add(Integer.parseInt(BlockedCity[j]));
                    }
                    //startCityField.setText(null);
                    //endCityField.setText(null);
                    //int from = (int) spinnerFromVertex.getValue();
                    ...
                    result = GraphAlgorithms.dfs(graph, startCity, endCity, blockedCity);
                    //System.out.print(first[0] ? "" : ", ");
                    //first[0] = false;
                    int k = result.size();
                    for (int i = 0; i < k; i++) {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("Enter start city:");
        ...
        panel5.add(endCityField, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        panel6.add(buttonDfsRecursion, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        startCityField = new JTextField();
        panel4.add(startCityField, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JLabel label3 = new JLabel();
        label3.setText("Enter block city:");
        ...
        blockedCityField = new JTextField();
        panel4.add(blockedCityField, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        panel7.add(spacer3, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
